...
"""
# 데이터 받아오기
train_file = "D:/University/KSNU/3_1_머신러닝종합설계/haksa-bot/haksaBot/tools/qna/train_test.xlsx" # train_data -> train_test 이름 변경 필요
...
class create_embedding_data:
    ...
    def create_pt_file(self):
        ...
        torch.save(embedding_data, './tools/qna/embedding_data.pt')
